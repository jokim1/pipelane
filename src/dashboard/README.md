...
```json
{
  ...
  "boardSubtitle": "Pipelane - release pipeline management and safety for AI vibe coders. Branch pipeline triage, action preflight, execution follow-through, deploy verification, and cleanup discipline.",
  "preferredPort": 3033,
